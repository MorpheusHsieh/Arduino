...
void ADXL345::calibrationModeInit()
{
  setDataFormat(FullRes_2G);
...
void ADXL345::readGains(double *gx, double *gy, double *gz)
{
  int x, y, z;
  readRawDatas(&x, &y, &z);
